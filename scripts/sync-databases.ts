...
const COLLECTIONS: Record<string, CollectionConfig> = {
  publications: {
    ...
    pipelineFields: ['external_citation_count', 'citation_count_updated_at', 'embedding', 'search_vector', 'full_text', 'pdf_rights_basis', 'pdf_rights_checked_at', 'rmbl_research_score', 'funding_program_evidence', 'funding_programs_checked_at'],
    curatedFields: ['title', 'abstract', 'year', 'journal', 'volume', 'issue', 'pages', 'doi', 'publisher', 'pdf_link', 'external_url', 'publication_type', 'data_source', 'discovery_method', 'pdf_restricted', 'pdf_source_description', 'pdf_acquired_at', 'rmbl_research', 'sfa_program', 'sail_program'],
