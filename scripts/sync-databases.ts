...
const COLLECTIONS: Record<string, CollectionConfig> = {
  publications: {
    ...
    pipelineFields: ['external_citation_count', 'citation_count_updated_at', 'embedding', 'search_vector', 'full_text', 'pdf_rights_basis', 'pdf_rights_checked_at', 'rmbl_research_score'],
