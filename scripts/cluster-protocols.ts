...
import { VOYAGE_API_KEY, EMBEDDING_DIMENSIONS } from './lib/config.js'
...
// Pick the canonical representative for each cluster using composite scoring.
// Scoring balances:
...
function selectCanonical(cluster: Cluster<Candidate>): CanonicalRecord {
