...
const PROMPT = `You are writing short descriptions of knowledge neighborhoods in the RMBL Knowledge Hub — a platform connecting scientific research, community documents, and environmental datasets from the Rocky Mountain Biological Laboratory and the Gunnison Basin of western Colorado.
