...
server.tool(
  'search_rmbl',
  'Search the RMBL Knowledge Hub for publications, datasets, and documents. Returns ranked results with relevance scores.',
  {
...
server.tool(
  'list_neighborhoods',
  'Browse or search the 154 research neighborhoods in the RMBL Knowledge Hub. Each neighborhood represents a research community detected by analyzing the knowledge graph.',
  {
...
async function main() {
  ...
  console.error('RMBL Knowledge Hub MCP server running on stdio')
}
