...
- **v0.11** (this revision): adds **Principle 5 — A recognizably different 2039** to §11.4. The v0.10 stories honored the four voice principles well but produced a world essentially indistinguishable from 2024 — the year on the page was 2039 but the texture wasn't. Principle 5 adds the world-building dimension: environmental shifts past adaptation into normal, technological change visible in how people work, social patterns evolved, and AI integrated in ways characters take for granted. Lean-into-strangeness permission for AI specifically: occasional uncanny moments treated as normal by the character. Test: if "2024" can be substituted for the year without changing anything material, the world isn't yet on the page.
