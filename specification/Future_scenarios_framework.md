...
### 4.1b Upside companion sets

The central scenario set's magnitude bracket (`$3M–$8M`) and continuity/innovation bracket (25/75 to 75/25) are deliberately contingency-honest — they describe what RMBL might plausibly raise and choose. They are not the entire envelope of plausible futures.

Some institutional questions benefit from explicitly bracketing **upside-tail futures** in which several favorable conditions stack: RMBL fundraising substantially exceeds the realistic ceiling *and* federal/foundation science funding expands *and* a durable shift in public attitudes integrates environmental research into policy. These upside conditions are correlated drivers — a public-attitude shift toward science would plausibly produce both private giving expansion and public funding growth — but not so correlated that one implies the others. Multiple driver-combinations remain possible.

An **upside companion set** packages these scenarios as a sibling artifact to the central set (e.g., `centennial-2027-upside` alongside `centennial-2027`). It serves a different audience and use:

- **Central set** — strategic planning, donor invitation in the realistic bracket, board decision-making about commitments under uncertainty. Contingency-honesty is paramount: each scenario names what could invalidate it and what other scenarios exist as alternatives.
- **Upside set** — leadership-and-board inspiration, donor invitation about what compounding investments make possible, scientific-community framing of long-arc impact. Contingency-honesty differs: the scenarios are explicitly named as upside-tail. Each scenario still names its dependencies (which favorable conditions need to hold) and what would collapse it (loss of any single driver), but it does not pretend to be the central case.

Upside-set scenarios are distinguished by which driver is primary:

- **Internal-driver upside** — RMBL fundraising over-performance is the central driver; external conditions are supportive but not transformative
- **External-driver upside** — public/foundation science funding expansion is the central driver; RMBL flourishing follows from operating in a richer funding ecosystem
- **Policy-driver upside** — a durable public-attitude shift toward science-informed environmental policy is the central driver; RMBL's role becomes translation-at-scale rather than place-based research alone

Upside scenarios should bend the magnitude bracket explicitly (`bracket_position: "above the realistic ceiling"`) and document the contextual conditions on which the bracket-bending depends (`upside_conditions:` field — a list of stacked-favorable conditions whose conjunction makes the scenario plausible). The `mattering_in_2040` field must remain honest about which conditions had to hold and what other paths existed.

The framework explicitly accepts upside companion sets as legitimate artifacts when the institutional question benefits from seeing the upside-tail clearly. They are not "fundraising fiction"; they are scenario work in a register the central set deliberately cannot reach.

### 4.1c Downside companion sets

The central set is contingency-honest about realistic-bracket outcomes. The upside set (§4.1b) explores what becomes possible when several favorable conditions stack. A **downside companion set** parallels the upside set on the other tail: it explores what becomes the texture of basin science when several *unfavorable* conditions stack — RMBL fundraising significantly under-performs, federal science funding contracts sharply, climate change advances faster than central-case modeling, public-attitude shifts away from science, or some combination of these.

The downside set serves a different audience and use than the central or upside sets:

- **Central set** — strategic planning, donor invitation in the realistic bracket
- **Upside set** — leadership-and-board inspiration, donor invitation about compounding possibility
- **Downside set** — risk identification, resilience planning, leadership preparation for the conditions under which constraint becomes the operating reality

Downside-set scenarios are distinguished by which *configuration of stacked unfavorable conditions* is primary — not which single driver is "the cause." Downside futures are usually multi-causal in a way upside futures often are not. The configurations the framework recommends covering:

- **Institutional-stress dominant** — Sustained federal contraction *plus* operational pressure (Gothic land-access, succession crises, lease pressure) *plus* declining donor appetite. The institution survives but as a smaller, narrower version. The pressure is on what can still be protected.
- **Environmental-acceleration dominant** — Climate change advances faster than central-case modeling. Some study species locally extirpated, some plots compromised by fire, the very systems the long records track stop existing as they were. The institution faces the question of what continuity means when discontinuity is the empirical truth.
- **Political-legitimacy dominant** — A durable shift in public attitudes *away* from science legitimacy, with federal hostility to environmental-research agencies disrupting basin-relevant partnerships. The institution's translation work becomes politically vulnerable. The question is how a place-anchored nonprofit operates when the political space for science narrows.

Each configuration involves all three challenge categories (institutional, environmental, social/political); they differ in which is primary. Downside scenarios must remain contingency-honest about *which* unfavorable conditions actually had to stack, and must not present the central case as if it were on the verge of becoming the downside. The honest framing is: these are downside-*tail* configurations whose conditions stacked.

Downside scenarios should bend the magnitude or operating-environment bracket explicitly downward (`bracket_position: "below the realistic floor"` or `"under sustained operating pressure"`) and document the stacked unfavorable conditions (`downside_conditions:` field). The `mattering_in_2040` field should describe what RMBL still does, not what it has lost — the institution remains an institution, with diminished options but real ones.
...
### 11.3a Forbidden patterns — upside companion sets

Stories in an upside companion set (per §4.1b) need an additional layer of forbidden patterns. The upside-tail register has its own failure modes — register that the central-set patterns alone don't catch.

- **Utopia.** Things are not better in the upside set because every problem has been solved. They are better because several favorable conditions stacked and the institution responded well. Characters in upside stories still have ordinary problems: bad weather, instrument failures, conflicts with collaborators, family obligations, federal-cycle uncertainty (federal cycles remain federal cycles even in a richer funding environment). The texture is *thriving*, not *idyllic*.
- **Deus-ex-machina policy shift.** The reader should not be told that the policy environment has improved — they should feel it as the texture of how characters work. A story should not contain a sentence like "since the Western Adaptive Co-Management Act passed in 2034." It can contain a character walking into a meeting that exists *because* such a shift happened, without naming it.
- **Scientists save the world.** RMBL is part of a larger ecosystem — peer field stations, university labs, agencies, tribal natural-resources offices, partner foundations, community partners. Even in the upside-tail futures, no individual scientist or institution carries the work alone. The thriving register makes collaborative scope visible; it does not collapse onto a hero.
...
- **Glossing the contingency.** Upside scenarios are *upside-tail*, not the central case. Stories grounded in them should occasionally acknowledge that the conditions that made this future possible were not the only ones that could have obtained — through a character's offhand reflection, a peer's situation at a different institution where conditions did not stack as favorably, or simply a memory of an earlier decade when the texture was thinner. The flourishing is felt as recently-arrived, not as natural.
- **Documentary register for the favorable conditions.** Do not have characters explain how public attitudes shifted or how federal policy reformed. The shift is the world; characters live in it. If the policy reform must be named at all, name it sideways and once.

These constraints are about preserving honesty in a register that, left unchecked, can slide into either utopia or fundraising-brochure tone. The optimism in the upside set should be *structural* — favorable conditions stacked — not *magical*.

### 11.3b Forbidden patterns — downside companion sets

Stories in a downside companion set (per §4.1c) need their own additional layer of forbidden patterns. The constrained-future register has its own failure modes the §11.3 list does not catch and that mirror §11.3a's upside list on the other tail.
...
- **Reactive helplessness.** Characters still act. Their action space is narrower than in the central case and much narrower than in the upside, but they have agency. Decisions are still being made. The §11.3 agency-under-stress rule applies more strictly here, not less.
- **Villain attribution.** The conditions are multi-causal — federal contraction *and* foundation appetite contracting *and* climate stress *and* social-political shifts, intersecting. The story does not blame an administration, a party, a federal agency, or any single actor. The downside conditions are conditions; characters operate inside them. (Real political opinions appear sideways, the way characters carry them, not as authorial finger-pointing.)
- **Nostalgia trap.** Characters live in the present, not in the basin-as-it-was. Memory has its place — a multi-decade observer remembering a colony, a senior scientist recalling a year of better snowpack — but the story's center of gravity is what is being done now, not what was done then. The §11.3 low-affect-resolution forbidden pattern doubles down here: a downside story is most vulnerable to closing on elegy.
- **False equivalence with the central case.** Downside scenarios are downside-*tail*. The story should acknowledge — sideways — that the conditions that produced this future were not the only ones that could have obtained, just as the upside set does on the other tail. A character's offhand reflection on a peer institution that fared better, a reference to a different state's choices, a memory of when the conditions could still have gone several ways. The downside is structural and contingent, not foreordained.
- **Heroism through suffering.** The institution and its people are not ennobled by hardship. They are working scientists having a harder decade than they wanted. They are competent, opinionated, sometimes funny, sometimes tired, and still doing the work. The story should make their thriving-within-constraint legible without sanctifying the constraint.
...
The character of a good downside story is **hardship without despair, constraint without collapse, real losses set against real ongoing work**. The §11.3 closings-forward rule is doubly load-bearing.
...
- **v0.16** (this revision): adds **§4.1c Downside companion sets** and **§11.3b Forbidden patterns — downside companion sets**, completing the tail-bracketing pair. Where §4.1b enables explicit upside-tail scenario work for inspiration and donor invitation, §4.1c enables explicit downside-tail work for risk identification, resilience planning, and leadership preparation. Downside scenarios are distinguished by configuration of stacked unfavorable conditions — institutional-stress-dominant, environmental-acceleration-dominant, political-legitimacy-dominant — rather than by single-driver, because downside futures are usually multi-causal. §11.3b forbidden-pattern rules for downside stories — no collapse/dystopia register, no "they lose everything," no reactive helplessness, no villain attribution, no nostalgia trap, no false equivalence with the central case, no heroism-through-suffering, no documentary register for the unfavorable conditions. The character of a good downside story is *hardship without despair, constraint without collapse, real losses set against real ongoing work*. First centennial-2027-downside generation lands with three scenarios + three stories (one per scenario, set 2040-2042 to mirror the upside set's window).
- **v0.15**: adds **§4.1b Upside companion sets** and **§11.3a Forbidden patterns — upside companion sets**, enabling explicit upside-tail scenario work as a sibling artifact to the central set. The central set is contingency-honest about realistic-bracket campaign outcomes; the upside set is honest in a different register — about what becomes possible when several favorable conditions stack (RMBL fundraising over-performance + science-funding expansion + a durable shift in public attitudes integrating environmental research into policy). Three driver-flavored scenarios in `centennial-2027-upside`: Flourishing (internal driver), Networked (external/funding driver), Adaptive (policy driver). §11.3a forbidden patterns for upside stories — no utopia, no deus-ex-machina policy shift, no scientists-save-the-world, no triumphalism, no glossing the contingency, no documentary-register explanation of how the favorable conditions arose. The upside register is *structural* (favorable conditions stacked), not *magical*. First centennial-2027-upside generation lands with three scenarios + three stories (one per scenario, set 2040-2042).
- **v0.14**: adds **§3.2a Factual anchors — long records** to correct a systematic conflation. Scenarios v1.0 and stories v0.8–v0.13 repeatedly described the marmot demographic study as "reaching its hundredth year" within the campaign horizon — borrowing the "centennial" framing from the campaign's name. This is wrong: the marmot study started in 1963 (Barash → Armitage → Blumstein); it passes its 75-year mark in 2038; its centennial is 2063, outside any horizon the framework operates inside. The Centennial Campaign is named for *RMBL's* centennial (RMBL founded 1928; institutional centennial 2028), not the records'. §3.2a inlines a table of actual record start dates and milestones. `scripts/generate-scenarios.ts` and `scripts/generate-stories.ts` mirror the table in their prompts so future generations stay grounded. The v1.0 scenarios and v0.13 stories are corrected in-place: ~80 marmot-centennial mentions replaced with accurate framing (e.g., "marmot study reaches its hundredth year" → "marmot study now in its eighth decade"; "marmot study's centennial in the early 2040s" → "marmot study's seventy-fifth year in 2038"). Two stories get prose edits: balance-2038 (replacing "Ninety-ninth year wrapping up. The centennial event in July" with the seventy-fifth-year version) and records-and-independence-2039 (replacing "the centennial happens at the reduced scale" with the seventy-fifth-year milestone). §F.cont.2 in §6 updated.
